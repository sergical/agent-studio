...
use super::skill_dto::{PaginatedSkillsResponse, SkillSearchResponse, SkillSearchResult};
...
pub async fn search_skills(
    ...
    let url = format!(
        ...
        SKILLS_API_BASE, encoded_query, limit, offset
    );
