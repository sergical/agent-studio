...
| Cursor        | `~/.cursor/projects/*/agent-transcripts/**/*.jsonl`                                                                                                                                                                                                            | docs name `/skill-name` (https://cursor.com/docs/skills); not seen in local data                                                                                                                                                                     | none: no skill tool in transcripts or in `state.vscdb` tool names                                                                                                                                                             | `Read`, `ReadFile`, or `Shell` call on a `SKILL.md`                     |
| Grok Build    | `~/.grok/sessions/<encoded-cwd>/<session-id>/`; record shapes unknown (no local data)                                                                                                                                                                          | `/skill-name` (`SkillTrigger::SlashCommand`)                                                                                                                                                                                                         | skill tool, registered only by vendor-compat tool sets (`SkillTrigger::SkillTool`)                                                                                                                                            | `read_file` of a known skill's `SKILL.md` (`SkillTrigger::SkillMdRead`) |
