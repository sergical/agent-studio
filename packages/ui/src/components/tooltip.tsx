// ============================================================================
// @skill-studio/ui - Tooltip
// Vendored from shadcn's Base UI registry (`shadcn add tooltip -b base`).
// Wrap the app root in <TooltipProvider> once, near the top of the tree.
// ============================================================================
  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Positioner
        ...
        className="isolate z-[var(--z-tooltip,50)]"
      >
